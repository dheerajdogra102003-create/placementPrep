// Microsoft Word Placement Application Logic
(function () {
    'use strict';
    ...
    function loadQuestions() {
        ...
        console.log(`Loaded ${allQuestions.length} MS Word questions.`);
    }
    ...
    function renderExplanation(q, selectedOptIndex) {
        ...
        explanationSummaryText.textContent = q.explanation || `Concept: ${q.concept}. Word features must be practiced for rapid recall in placement rounds.`;
        explanationWhyCorrect.textContent = q.whyCorrect || `${correctText} is the correct operation/feature in MS Word.`;
        ...
        textRealWorld.textContent = q.realWorldApplication || `Mastering ${q.concept || 'MS Word features'} is essential for document preparation and corporate technical assessments.`;
    }
    ...
    function renderResultsBreakdown() {
        ...
        Object.entries(topicMap).forEach(([topName, data]) => {
            ...
            card.innerHTML = `
                <div class="breakdown-card-header">
                    <span class="breakdown-diff-dot word"></span>
                    <div>
