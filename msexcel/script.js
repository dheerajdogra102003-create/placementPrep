// Microsoft Excel Placement Application Logic
(function () {
    'use strict';
    ...
    function loadQuestions() {
        ...
        console.log(`Loaded ${allQuestions.length} MS Excel questions.`);
    }
    ...
    function renderCurrentQuestion() {
        ...
        badgeQTopic.textContent = q.topic || 'Excel';
        badgeQConcept.textContent = q.concept || 'Spreadsheet';
    ...
    function renderExplanation(q, selectedOptIndex) {
        ...
        explanationSummaryText.textContent = q.explanation || `Concept: ${q.concept}. Excel formula and function behaviors must be memorized for speed.`;
        explanationWhyCorrect.textContent = q.whyCorrect || `${correctText} is the correct formula/operation.`;
        ...
        textRealWorld.textContent = `Excel functions like ${q.concept || 'this'} are crucial in data cleaning, automated reporting, and corporate technical assessments.`;
    }
    ...
    function submitExam() {
        ...
        Object.keys(topicStats).forEach(topic => {
            ...
            card.innerHTML = `
                <div class="breakdown-card-header">
                    <span class="breakdown-diff-dot excel"></span>
                    <div>
                        <strong>${topic}</strong>
                        <p>${data.total} questions</p>
                    </div>
